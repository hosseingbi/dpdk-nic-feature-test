...
public:
    ...
    virtual void set_rss_qinxq_config(u_int16_t port_id, rte_eth_conf &port_conf);
    virtual void set_rss_qinxq_rte_flow_config(uint16_t port_id, u_int32_t nb_queues, u_int32_t nb_vlans);
